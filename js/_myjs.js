function post_image() {
    ...
    document.getElementById("fastapi_status").innerHTML = "&#128992; Connecting...";
    ...
    $.ajax({
      ...
      error: function(xhr, textStatus, error) {
          ...
          document.getElementById("fastapi_status").innerHTML = "&#128308; Error!"
      },
      success: function(data, textStatus, xhr) {
          ...
          document.getElementById("fastapi_status").innerHTML = "&#128994; Ready"
      },
